...
// };
var preProcessing = function (res, imageName, width, height) {
    // image full path
    var imgPath = "".concat(imgDir).concat(imageName, ".jpg");
    // the new resized image desired full path
    var newImgPath = path_1.default.resolve("".concat(imagesPath, "/").concat(imageName, "_thumb.jpg"));
    imageResize(imgPath, newImgPath, width, height).then(function (data) {
...
var imageResize = function (imgPath, newImgPath, width, height) {
                    ...
                    return __awaiter(this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                return [4 /*yield*/, fs_1.promises.readFile(newImgPath).then(function (c) {
                                        resolve(c);
                                    })];
                                case 1:
                                    // read the current resized image and display it
...
exports.default = { preProcessing: preProcessing, imageResize: imageResize };
